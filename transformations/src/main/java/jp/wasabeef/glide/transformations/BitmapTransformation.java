...
public abstract class BitmapTransformation implements Transformation<Bitmap> {
  ...
  // Public API.
  @SuppressWarnings("WeakerAccess") public BitmapTransformation() {
    // Intentionally empty.
  }
   ...
   */
  @Deprecated public BitmapTransformation(@SuppressWarnings("unused") Context context) {
    this();
  }
   ...
   * @deprecated Use {@link #BitmapTransformation()}.
   */
  @Deprecated public BitmapTransformation(@SuppressWarnings("unused") BitmapPool bitmapPool) {
    this();
  }
